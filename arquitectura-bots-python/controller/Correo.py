...
class Correo:
    ...
    def __init__(self):
        ...
        """
        self.__remitente = "<RobotAutomatizaciones@emergiacc.com>" 
        self.__asuntoCorreo= "Alerta Robot automatizaciones" 
        self.__destinatarios = ['<developer@emergiacc.com>']
    ...
    def EjecutarEnvioCorreo(self):
        ...
        smtp = smtplib.SMTP('10.200.10.135')
        smtp.starttls() 
        email = msg.as_string() 
